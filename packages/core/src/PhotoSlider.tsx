...
import SlidePortal, { SlidePortalRef } from './components/SlidePortal'
...
const PhotoSlider = forwardRef<SlidePortalRef, IPhotoSliderProps>(
  (props: IPhotoSliderProps, ref) => {
    const {
      mode: modeProp = 'slide',
      loop = 3,
      speed: speedFn,
          ...
          return (
            <PhotoBox
              ...
              style={{
                ...
                transition:
                  touched || pause ? undefined : `transform ${slideSpeed}ms ${slideEasing}`,
              }}
